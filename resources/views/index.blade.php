...
@section('content')
    <div class="relative flex items-top min-h-screen py-4 sm:pt-0">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="myTabContent">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="ofertas" role="tabpanel"
                    aria-labelledby="ofertas-tab">
                    <p class="text-sm text-gray-500 dark:text-gray-400">This is some placeholder content the <strong
                            class="font-medium text-gray-800 dark:text-white">ofertas tab's associated content</strong>.
                        Clicking
                        ...
                        @foreach ($products as $product)
                            <div
                                ...
                                <div class="p-5">
                                    ...
                                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $product->descripcion }}
                                    </p>
                                    <div>
