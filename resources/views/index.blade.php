            ...
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="ofertas-tab" data-tabs-target="#ofertas"
                            type="button" role="tab" aria-controls="ofertas" aria-selected="false">Inicio</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button
                    ...
                    <li class="mr-2" role="presentation">
                        <button
                            class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                            id="n-productos" data-tabs-target="#nproductos" type="button" role="tab"
                            aria-controls="nproductos" aria-selected="false">Nuevos productos</button>
                    </li>
                </ul>
            </div>
            <div id="myTabContent">
