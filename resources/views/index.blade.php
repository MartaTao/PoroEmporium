...
@section('content')
    <div class="relative flex items-top min-h-screen py-4 sm:pt-0">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="inicio-tab" data-tabs-target="#inicio"
                            type="button" role="tab" aria-controls="inicio" aria-selected="false">Inicio</button>
                    </li>
                    <li class="mr-2" role="presentation">
                        <button
            ...
            <div id="myTabContent">
                <div class="hidden p-4 rounded-lg" id="inicio" role="tabpanel" aria-labelledby="inicio-tab">
                    <h1 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Productos nuevos
                    </h1>
                    ...
                    <div class="my-3 grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-1 gap-3">
                        @foreach ($nuevosProductos->take(5) as $product)
                            <div
                                ...
                                <div class=" h-72 w-full  bg-cover bg-center p-2"
                                    style="background-image: url({{ $product->getMedia('products_avatar')->first()? $product->getMedia('products_avatar')->first()->getUrl(): 'https://m.media-amazon.com/images/I/81fV-9eUG5L._AC_SL1500_.jpg' }})">
                                        ...
                                        @else
                                            ...
                                            @if (floor($product->valoracion) < $product->valoracion)
                                                <svg xmlns="http://www.w3.org/2000/svg" stroke-width="0.5"
                                                    class="bi bi-snow3 text-blue-400 dark:text-blue-200 w-5 h-5"
                                                    viewBox="0 0 16 16">
                                                    <path d="M 8 7.5 a 0.5 0.5 0 1 0 0 1 z" fill="#C3DDFD"
                                                        stroke="#C3DDFD" />
                                                    <path d="M 8 7.5 a 0.5 0.5 0 0 1 0 1 z" fill="#76A9FA"
                                                        stroke="#76A9FA" />
                                                    <path
                                            ...
                                            @endif
                                            @for ($i = floor($product->valoracion); $i < 5; $i++)
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    stroke="currentColor" stroke-width="0.5"
                                                    class="bi bi-snow3 text-blue-300 dark:text-blue-400 w-5 h-5"
                                                    viewBox="0 0 16 16">
                    ...
                    <h1 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ofertas</h1>
                    <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                    <div class="my-3 grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-1 gap-3">
                        @foreach ($descuentos as $descuento)
                            <div
                                class="max-w-sm bg-sky-50 border border-gray-200 rounded-lg shadow dark:bg-gray-900 dark:border-gray-700">
                                <div class=" h-72 w-full  bg-cover bg-center p-2"
                                    style="background-image: url({{ $descuento->product->getMedia('products_avatar')->first()? $descuento->product->getMedia('products_avatar')->first()->getUrl(): 'https://m.media-amazon.com/images/I/81fV-9eUG5L._AC_SL1500_.jpg' }})">
                                    <span
                                        class="uppercase text-2xl bg-red-50 p-0.5 border-red-500 border rounded text-red-700 font-medium">
                                        {{ $descuento->descuento }}%
                                    </span>
                                </div>
                                <div class="p-5">
                                    ...
                                    <div class="flex items-center mt-2.5 mb-5">
                                        ...
                                        @else
                                            ...
                                            @endif
                                            @for ($i = floor($descuento->product->valoracion); $i < 5; $i++)
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                    stroke="currentColor" stroke-width="0.5"
                                                    class="bi bi-snow3 text-blue-300 dark:text-blue-400 w-5 h-5"
                                                    viewBox="0 0 16 16">
                                        ...
                                        @endif
                                        <span
                                            class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-3">{{ !is_null($descuento->product->valoracion) ? $descuento->product->valoracion : '0.0' }}</span>
                                    </div>
                                    <p class="text-3xl font-bold text-gray-900 dark:text-white"><span
